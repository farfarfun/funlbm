...
# Initialize lattice
lattice = Lattice(nx=nx, ny=nx, dx=1.0 / nx, dt=dt, tau_lbm=tau_lbm, Re_lbm=Re_lbm, u_lbm=u_lbm, L_lbm=L_lbm,
                  nu_lbm=nu_lbm, rho_lbm=rho_lbm, dpi=dpi, t_max=t_max, it_max=it_max)
